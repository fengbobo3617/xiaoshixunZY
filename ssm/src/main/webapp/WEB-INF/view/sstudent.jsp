...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservesstudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td><input type="text" id="ssname" name="sname" class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	//报表弹框 $('#modal_user_del').modal('hide') $("#btn_search").click();=隐藏弹框 调用查询
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	if(res.success){
	    			    		...
	    			    		var ydata=new Array();
	    			    		//循环集合
	    			    		var sslist=res.sslist;
	    			    		sslist.forEach(function(sstudent){
	    			    			xdata.push(sstudent.scname);
	    			    			ydata.push({value:sstudent.num,name:sstudent.scname});
