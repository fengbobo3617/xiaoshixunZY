...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reservepperson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入职时间：</td>
								<td><input type="date" id="bithday" name="bithday" class="form-control" aria-required="true" required /></td>
								<td>&nbsp;&nbsp;</td>
	...
	function initEditUser(getSelection){
		...
		$('#bithday').val(new Date(getSelection.bithday).Format("yyyy-MM-dd"));
